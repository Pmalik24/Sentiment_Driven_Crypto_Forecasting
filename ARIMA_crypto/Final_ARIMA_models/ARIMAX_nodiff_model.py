...
df = pd.read_csv('clean_nodiff_final.csv', index_col='timestamp')
...
exog_features = ["Market Cap", 'open', 'high', 'low', '2yr_yield', '5yr_yield', '7yr_yield']
...
with open('best_nodiff_arimax_models.pkl', 'wb') as f:
...
with open('best_nodiff_arimax_model_trainerror.txt', "a") as file:
...
residuals_df.to_csv('training_residuals_nodiff.csv', index=False)
