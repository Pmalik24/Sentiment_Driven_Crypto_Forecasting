...
with open('best_nodiff_arimax_models.pkl', 'rb') as f:
...
for coin_id in best_models.keys():
    ...
    if model is not None:
        ...
        with open('best_nodiff_arimax_model_testerror.txt', "a") as file:
...
residuals_df.to_csv('test_residuals_nodiff.csv', index=False)
