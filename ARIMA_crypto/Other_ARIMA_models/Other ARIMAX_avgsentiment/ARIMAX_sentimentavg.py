...
df = pd.read_csv('clean_nodiff_sentiment_copy.csv', index_col='timestamp')
...
with open('sent_nodiff_arimax_models_copy.pkl', 'wb') as f:
...
with open('sent_nodiff_arimax_model_trainerror_copy.txt', "a") as file:
...
residuals_df.to_csv('training_residuals_nodiff_sent_copy.csv', index=False)
