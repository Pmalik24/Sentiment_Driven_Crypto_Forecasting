...
exog_features = ["Market_Cap_diff", 'open_diff', 'high_diff', 'low_diff', '2yr_yield', '5yr_yield', '7yr_yield']
...
with open('best_arimax_models.pkl', 'wb') as f:
...
with open('best_arimax_model_trainerror.txt', "a") as file:
...
residuals_df.to_csv('training_residuals.csv', index=False)
